...
train_data_encoded <- read.csv("C:/Users/Hiruni/OneDrive/Desktop/train_balanced.csv")


test_data_encoded  <- read.csv("C:/Users/Hiruni/OneDrive/Desktop/test_encoded.csv")
