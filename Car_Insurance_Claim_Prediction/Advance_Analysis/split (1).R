...
df=read.csv("C:/Users/Hiruni/OneDrive/Desktop/full_transformed.csv")
...
# Save as CSV files
write.csv(train_data, 'C:/Users/Hiruni/OneDrive/Desktop/train_set.csv', row.names = FALSE)
write.csv(test_data, 'C:/Users/Hiruni/OneDrive/Desktop/test_set.csv', row.names = FALSE)
